 ...
 * @author Stefan Balev
 */
public class MultiModalDijkstra extends AbstractSpanningTree {
	 ...
	 *            automatically.
	 */
	public MultiModalDijkstra(String resultAttribute,
	 ...
	 *            spanning tree
	 */
	public MultiModalDijkstra(String resultAttribute, NumberProvider numberProvider, String flagAttribute, Object flagOn, Object flagOff) {
	...
	protected void makeTree(double volume) {
		...
		while (!heap.isEmpty()) {
			...
			updateLengthLeavingEdge(u, dataU.edgeFromParent, dataU.distance, volume);
